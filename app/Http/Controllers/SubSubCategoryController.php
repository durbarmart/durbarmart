...
class SubSubCategoryController extends Controller
{
    ...
    {
        $sort_search =null;
        $subsubcategories = Category::where('type','SubSubCategory')->orderBy('created_at', 'desc');
    ...
    public function store(Request $request)
    {
        ...
        $subsubcategory->type = 'SubSubCategory';
        $subsubcategory->parent = $request->sub_category_id;
    ...
    {
        $subsubcategory = Category::findOrFail(decrypt($id));
        $categories = Category::where('type','Category')->get();
        $brands = Brand::all();
    ...
    {
        $subsubcategories = Category::where('parent', $request->sub_category_id)->get();
