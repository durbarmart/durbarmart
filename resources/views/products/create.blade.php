			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="number" min="0" value="0" step="0.01" placeholder="{{__('Tax')}}" name="tax" class="form-control" value="0">
						</div>
						<div class="col-lg-1">
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="number" min="0" value="0" step="0.01" placeholder="{{__('Discount')}}" name="discount" class="form-control" value="0">
						</div>
						<div class="col-lg-1">
...
<script type="text/javascript">
	...
	function get_subsubcategories_by_subcategory(){
		...
		$.post('{{ route('subsubcategories.get_subsubcategories_by_subcategory') }}',{_token:'{{ csrf_token() }}', sub_category_id:subcategory_id}, function(data){
