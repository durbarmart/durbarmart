            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <p class="text-semibold text-3x text-main">{{ \App\Category::where('type','Category')->get()->count() }}</p>
                ...
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <p class="text-semibold text-3x text-main">{{ \App\Category::where('type','SubSubCategory')->get()->count() }}</p>
            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <p class="text-semibold text-3x text-main">{{ \App\Category::where('type','SubCategory')->get()->count() }}</p>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped mar-no">
                            ...
                            <tbody>
                                @foreach (\App\Category::where('type','Category')->get() as $key => $category)
                                    <tr>
