                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['categories.allCats'])}}">
                                        <a class="nav-link" href="{{route('categories.allCats')}}">{{__('All Categories')}}</a>
                                    </li>
                                    ...
                                    <li class="{{ areActiveRoutes(['subsubsubcategories.index', 'subsubsubcategories.create', 'subsubsubcategories.edit'])}}">
                                        <a class="nav-link" href="{{route('subsubsubcategories.index')}}">{{__('Sub Sub Sub Subcategory')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['subsubsubsubcategories.index', 'subsubsubsubcategories.create', 'subsubsubsubcategories.edit'])}}">
                                        <a class="nav-link" href="{{route('subsubsubsubcategories.index')}}">{{__('Sub Sub Sub Sub Subcategory')}}</a>
                                    </li>
