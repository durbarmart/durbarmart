...
@section('meta')
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1258918968114855"
         crossorigin="anonymous"></script>
    <!-- durbarmart ads -->
    <ins class="adsbygoogle"
         style="display:block"
         data-ad-client="ca-pub-1258918968114855"
         data-ad-slot="3771207204"
         data-ad-format="auto"
...
<section id="breadcrumb-wrapper" class="position-relative bg-light d-md-block d-none">
   ...
   <div class="container">
    <ol class="breadcrumb mt-3 py-3">
        ...
        @php
        // dd($detailedProduct);
            $main_id=\App\Category::where('id',$detailedProduct->main_id)->with('parentSubSubSubWithSubSub')->first();
            // $array = $main_id->toArray();
            $category=\App\Category::where('id',$detailedProduct->category_id)->first();
            $sub_category=\App\Category::where('id',$detailedProduct->subcategory_id)->first();
            $sub_sub=\App\Category::where('id',$detailedProduct->subsubcategory_id)->first();
            $sub_sub_sub=\App\Category::where('id',$detailedProduct->subsubsubcategory_id)->first();
            $sub_sub_sub_sub=\App\Category::where('id',$detailedProduct->subsubsubsubcategory_id)->first();
            $sub_sub_sub_sub_sub=\App\Category::where('id',$detailedProduct->subsubsubsubsubcategory_id)->first();
            $sub_sub_sub_sub_sub_sub=\App\Category::where('id',$detailedProduct->subsubsubsubsubsubcategory_id)->first();
    //    dd(colsFromArray3([$array],['name','slug']));
    //    dd($main_id,$category,$sub_category,$sub_sub,$sub_sub_sub,$sub_sub_sub_sub);
        @endphp
        <li>
            <a class="text-dark font-weight-bold"  href="{{ route('products.collectionSlug',$category->slug) }}">{{$category->name}}</a>
        </li>
        @if ($sub_category!=null)
            <li>
                <a class="text-dark font-weight-bold" href="{{ route('products.collectionSlug',$sub_category->slug) }}">{{$sub_category->name}}</a>
            </li>
            @if ($sub_sub!=null)
                <li>
                    <a class="text-dark font-weight-bold" href="{{ route('products.collectionSlug',$sub_sub->slug) }}">{{$sub_sub->name}}</a>
                </li>
                @if ($sub_sub_sub!=null)
                    <li>
                        <a class="text-dark font-weight-bold" href="{{ route('products.collectionSlug',$sub_sub_sub->slug) }}">{{$sub_sub_sub->name}}</a>
                    </li>
                    @if ($sub_sub_sub_sub!=null)
                        <li>
                            <a class="text-dark font-weight-bold" href="{{ route('products.collectionSlug',$sub_sub_sub_sub->slug) }}">{{$sub_sub_sub_sub->name}}</a>
                        </li>
                        @if ($sub_sub_sub_sub_sub!=null)
                            <li>
                                <a class="text-dark font-weight-bold" href="{{ route('products.collectionSlug',$sub_sub_sub_sub_sub->slug) }}">{{$sub_sub_sub_sub_sub->name}}</a>
                            </li>
                            @if ($sub_sub_sub_sub_sub_sub!=null)
                                <li>
                                    <a class="text-dark font-weight-bold" href="{{ route('products.collectionSlug',$sub_sub_sub_sub_sub_sub->slug) }}">{{$sub_sub_sub_sub_sub_sub->name}}</a>
                                </li>
                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="row align-items-center">
                                <div class="sold-by col-auto">
                                    ...
                                    @if ($detailedProduct->added_by == 'seller' && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                        @if (isset($detailedProduct->user->shop))
                            ...
                            @if ($detailedProduct->added_by == 'seller')
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-10">
                                        @if (isset($detailedProduct->user->seller) && $detailedProduct->user->seller->verification_status == 1)
                                            {{__('Verified seller')}}
                                        @else
                    ...
                    <div class="my-4 bg-white p-3">
                        ...
                        <div class="caorusel-box arrow-round gutters-5">
                            <div class="slick-carousel" data-slick-items="5" data-slick-xl-items="5" data-slick-lg-items="5"  data-slick-md-items="3" data-slick-sm-items="2" data-slick-xs-items="2"  data-slick-rows="1">
                                @foreach ((\App\Product::where('subcategory_id', $detailedProduct->subcategory_id)->where('id', '!=', $detailedProduct->id))->where('published',1)->limit(10)->get() as $key => $related_product)
                ...
                <div class="col-xl-3 d-xl-block">
                    <div class="seller-info-box mb-3">
                        <div class="sold-by position-relative">
                            @if (isset($detailedProduct->user->seller) && $detailedProduct->added_by == 'seller' && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1 && $detailedProduct->user->seller->verification_status == 1)
                            ...
                            @if(isset($detailedProduct->user->seller) && $detailedProduct->added_by == 'seller' && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
