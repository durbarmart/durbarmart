...
@if (isset($subsubcategory_id) && !empty($subsubcategory_id))
    @php
        $meta_title = \App\Category::find($subsubcategory_id)->meta_title;
        $meta_description = \App\Category::find($subsubcategory_id)->meta_description;
    @endphp
@elseif (isset($subcategory_id))
    @php
        $meta_title = \App\Category::find($subcategory_id)->meta_title;
        $meta_description = \App\Category::find($subcategory_id)->meta_description;
    @endphp
                    ...
                    <ul class="breadcrumb">
                        ...
                        @if (isset($category_id))
                            @if (\App\Category::find($category_id)->slug != null)
                                <li class="active"><a
                                        href="{{ route('products.collectionSlug', \App\Category::find($category_id)->slug) }}">{{ \App\Category::find($category_id)->name }}</a>
                                </li>
                            @endif
                        @endif
                        @if (isset($subcategory_id) && !empty($subcategory_id))
                            @php
                                $subcategory = \App\Category::where('id', $subcategory_id)
                                    ->with('parentCat')
                                    ->first();
                            @endphp
                            <li>
                                <a href="{{ route('products.collectionSlug', $subcategory->parentCat->slug) }}">
                                    {{ $subcategory->parentCat->name }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('products.collectionSlug', $subcategory->slug) }}">
                                    {{ $subcategory->name }}
                                </a>
                            </li>

                            <li class="active"><a
                                    href="{{ route('products.collectionSlug', \App\Category::find($subcategory_id)->slug) }}">{{ \App\Category::find($subcategory_id)->name }}</a>
                            </li>
                        @endif
                        @if (isset($subsubcategory_id) && !empty($subsubcategory_id))
                            @php
                                $subsubcategory = \App\Category::where('id', $subsubcategory_id)
                                    ->with('parentSubWithCat')
                                    ->first();
                            @endphp
                            <li>
                                <a
                                    href="{{ route('products.collectionSlug', $subsubcategory->parentSubWithCat->parentCat->slug) }}">
                                    {{ $subsubcategory->parentSubWithCat->parentCat->name }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('products.collectionSlug', $subsubcategory->parentSubWithCat->slug) }}">
                                    {{ $subsubcategory->parentSubWithCat->name }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('products.collectionSlug', $subsubcategory->slug) }}">
                                    {{ $subsubcategory->name }}
                                </a>
                            </li>
                            <li class="active"><a
                                    href="{{ route('products.collectionSlug', \App\Category::find($subsubcategory_id)->slug) }}">{{ \App\Category::find($subsubcategory_id)->name }}</a>
                            </li>
                        @endif
                    </ul>
                </div>
            ...
            <form class="" id="search-form" action="{{ route('search') }}" method="GET">
                <div class="row">
                        ...
                        <div class="filter-wrapper c-scrollbar">
                                    ...
                                    <div class="category-filter">
                                        <ul>
                                            @if (!isset($category_id) && !isset($category_id) && !isset($subcategory_id) && !isset($subsubcategory_id))
                                                @foreach (\App\Category::where('type', 'Category')->get() as $category)
                                                    @if ($category->slug != null)
                                                        <li class=""><a
                                                                href="{{ route('products.collectionSlug', $category->slug) }}">{{ __($category->name) }}</a>
                                                        </li>
                                                    @endif
                                                @endforeach
                                            @endif
                                            @if (isset($category_id))
                                                ...
                                                <li class="active"><a
                                                        href="{{ route('products.collectionSlug', \App\Category::find($category_id)->slug) }}">{{ __(\App\Category::find($category_id)->name) }}</a>
                                                </li>
                                                @foreach (\App\Category::find($category_id)->subcategories as $key2 => $subcategory)
                                                    <li class="child"><a
                                                            href="{{ route('products.collectionSlug', $subcategory->slug) }}">{{ __($subcategory->name) }}</a>
                                                    </li>
                                                @endforeach
                                            @endif
                                            @if (isset($subcategory_id))
                                                <li class="active"><a
                                                        href="{{ route('products') }}">{{ __('All Categories') }}</a></li>
                                                <li class="active"><a
                                                        href="{{ route('products.collectionSlug', $subcategory->parentCat->slug) }}">{{ $subcategory->parentCat->name }}</a>
                                                </li>
                                                <li class="active"><a
                                                        href="{{ route('products.collectionSlug', $subcategory->slug) }}">{{ $subcategory->name }}</a>
                                                </li>
                                                @foreach (\App\Category::find($subcategory_id)->subsubcategories as $key3 => $subsubcategory)
                                                    <li class="child"><a
                                                            href="{{ route('products.collectionSlug', $subsubcategory->slug) }}">{{ __($subsubcategory->name) }}</a>
                                                    </li>
                                                @endforeach
                                            @endif
                                            @if (isset($subsubcategory_id))
                                                <li class="active"><a
                                                        href="{{ route('products') }}">{{ __('All Categories') }}</a></li>
                                                <li class="active"><a
                                                        href="{{ route('products.collectionSlug', $subsubcategory->parentSubWithCat->parentCat->slug) }}">{{ $subsubcategory->parentSubWithCat->parentCat->name }}</a>
                                                </li>
                                                <li class="active"><a
                                                        href="{{ route('products.collectionSlug', $subsubcategory->parentSubWithCat->slug) }}">{{ $subsubcategory->parentSubWithCat->name }}</a>
                                                </li>
                                                <li class="current"><a
                                                        href="{{ route('products.collectionSlug', $subsubcategory->slug) }}">{{ $subsubcategory->name }}</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                            ...
                            <div class="bg-white sidebar-box mb-3">
                                ...
                                <div class="box-content">
                                    ...
                                    <select class="form-control sortSelect" data-placeholder="{{ __('All Brands') }}"
                            ...
                            <div class="bg-white sidebar-box mb-3">
                                ...
                                <div class="box-content">
                                    <div class="range-slider-wrapper mt-3">
                                        ...
                                        @endphp
                                        <div id="input-slider-range" data-range-value-min="{{ $min }}"
                    ...
                    <div class="col-xl-9">
                        ...
                        @endif
                        @if (isset($subcategory_id) && !empty($subcategory_id))
                            <input type="hidden" name="subcategory" value="{{ \App\Category::find($subcategory_id)->slug }}">
                        @endif
                        @if (isset($subsubcategory_id) && !empty($subsubcategory_id))
                            <input type="hidden" name="subsubcategory" value="{{ \App\Category::find($subsubcategory_id)->slug }}">
                        @endif
                        @if (isset($subsubsubcategory_id) && !empty($subsubsubcategory_id))
                            <input type="hidden" name="subsubsubcategory" value="{{ \App\Category::find($subsubsubcategory_id)->slug }}">
                        @endif
                        @if (isset($subsubsubsubcategory_id) && !empty($subsubsubsubcategory_id))
                            <input type="hidden" name="subsubsubsubcategory" value="{{ \App\Category::find($subsubsubsubcategory_id)->slug }}">
                        @endif
                        ...
                        <div class="products-box-bar p-3 bg-white">
                            <div class="row">
                                                ...
                                                <div class="product-box-2 bg-white alt-box my-md-2">
                                                        ...
                                                        <a href="{{ route('product', $product->slug) }}"
                                                            ...
                                                            @if (empty($product->featured_img))
                                                                <img class="img-fit lazyload mx-auto"
                                                                    ...
                                                                    alt="{{ __($product->name . '-' . $product->unit_price) }}">
                                                            @else
                                                                <img class="img-fit lazyload mx-auto"
                                                                    src="{{ asset('frontend/images/placeholder.jpg') }}"
                                                    ...
                                                    <div class="p-md-3 p-2">
                                                        <span class="product-price strong-600"
                                                            style="font-size: 15px">{{ home_discounted_base_price($product->id) }}</span>
                                ...
                                @else
                                    <div
                                        class="nothing-wrap d-flex justify-content-center w-100 align-items-center flex-column">
                                        <p class="pt-3">Sorry, Nothing to show here.</p>
                                        <img src="{{ asset('img/client-images/Add to Cart-amico.svg') }}"
                                            class="nothing">
                                    </div>
                                @endif
                            </div>
