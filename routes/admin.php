...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/cat-tree', 'CategoryController@catTree')->name('catTree');

	
	Route::get('/truncate/{table}', 'CategoryController@truncate')->name('truncate');
	...
	Route::resource('subsubsubcategories','SubSubSubCategoryController');
	Route::get('/subsubsubcategories/destroy/{id}', 'SubSubSubCategoryController@destroy')->name('subsubsubcategories.destroy');

	Route::resource('subsubsubsubcategories','SubSubSubSubCategoryController');
	Route::get('/subsubsubsubcategories/destroy/{id}', 'SubSubSubSubCategoryController@destroy')->name('subsubsubsubcategories.destroy');
	...
	Route::get('/categories-export', 'CategoryController@exportCategory')->name('categories.exportCategory');

	Route::get('/all-categories', 'CategoryController@all')->name('categories.allCats');
	Route::get('/category-bulk-delete', 'CategoryController@bulkDelete')->name('category.bulkDelete');
	...
	Route::get('/seller-bulk-delete', 'SellerController@bulkDelete')->name('seller.bulkDelete');
	// Route::get('/sellers/bulkDelete', 'SellerController@bulkDelete')->name('seller.bulkDelete');
