...
Route::post('/subsubsubcategories/get_subsubsubcategories_by_subsubcategory', 'SubSubSubCategoryController@get_subsubsubcategories_by_subsubcategory')->name('subsubsubcategories.get_subsubsubcategories_by_subsubcategory');
...
Route::get('/products-123123123123123123', 'ProductController@test13123')->name('test123123');
Route::get('/products-slug-dublicate-change', 'ProductController@slugDuplication')->name('slugDuplication');
...
Route::get('/collections/{slug}', 'HomeController@collectionSlug')->name('products.collectionSlug');
